...
// task1
// for (let i = 0; i < products.length; i++) {
//     let salePrice = products[i].price - products[i].price * 10 / 100;
//     console.log(`<div>
//     <p>product: ${products[i].name} </p>
//     <p>old price: ${products[i].price} </p>
...
//     return num**exponent; // поговаривают что ** не во всех браузерах отробатывает 
// }
...
//variant 3
// function power_recursion(num,exponent) {
//     if (exponent != 1) {
//     return num *= power_recursion(num,exponent - 1);
//     }
//     return num;
// }
// console.log(power_recursion(5,2));
...
// for (let i = 0; i < products.length; i++) {
//     if (products[i].image == "") {
//         item_image = "./images/img.png";
//     } else {
//         item_image = image_path + products[i].image;
//     }

// goods.innerHTML += `<div class="goods__item">
//     <img src="${item_image}" alt="">
//     <p class="goods__title">${products[i].name}</p>
//     <p class="goods__category">category: <span>${products[i].category}</span></p>
//     <p class="goods__price">$ ${products[i].price}</p>
// </div>`;
// }

products.map(item => (goods.innerHTML += `<div class="goods__item">
<img src="${item.image ? image_path + item.image : "./images/img.png"}" alt="">
<p class="goods__title">${item.name}</p>
<p class="goods__category">category: <span>${item.category}</span></p>
