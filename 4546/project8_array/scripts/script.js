...
/* Массивы и циклы 
    ...
    .push() - метод, который добавит значение в конец массива
    .unshift() - метод, который добавляет в начало массива
    .pop() - метод, который  удалит значение с конца массива
