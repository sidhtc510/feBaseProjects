...
const posts = [
  {
    ...
    descr: "Берлин - ....",
    img: "Berlin_II_MartinSchwartz-150x150.webp",
  },
  {
    title: "Столица Кыргызстана",
    descr: "Бишкек - ...",
    img: "dostoprimechatelnosti-bishkeka-150x150.webp",
  },
];

const body = document.querySelector(".contentWrapper");
